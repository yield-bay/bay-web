...
const RemoveLiquidityModal = () => {
  ...
  const {
    ...
    args: [
      ...
      methodId == 0
        ? parseFloat(lpBalance?.formatted ?? "0") * parseFloat(percentage)
        : parseFloat(lpTokens), // Liquidity
          ...
          <MButton
            ...
            text={
              isSuccessLpApprove
                ...
                : isLoadingLpApprove
                ? "Approving..."
                : `Approve ${farm?.asset.symbol} Token`
            }
            disabled={
              isSuccessLpApprove ||
              (methodId == 0
  ...
  return methodId === 0 ? (
    ...
    <div className="relative flex flex-col gap-y-5">
      ...
      <div className="absolute bottom-4 left-4">
        <span className="text-base text-[#898989] leading-[21.6px]">
          {parseFloat(lpTokens) > 0
            ? ((parseFloat(lpTokens) * 100) / (lpBalanceNum as number)).toFixed(
                2
              )
            : 0}
          %
