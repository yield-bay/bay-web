    ...
    <Transition.Root show={open} as={Fragment}>
      ...
      >
        <div className="flex items-center justify-center min-h-screen px-9 text-center">
          ...
          >
            <div className="relative inline-block border-2 border-[#314584] bg-white dark:bg-baseBlue rounded-lg text-left py-8 align-bottom w-full transform transition-all">
