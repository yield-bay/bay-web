...
export default function SearchInput({ term, setTerm }: SearchInputProps) {
  ...
  return (
    <div className="relative flex w-full max-w-sm sm:max-w-md lg:max-w-[482px] text-primaryBlue dark:text-primaryWhite sm:rounded-md sm:shadow-sm ring-transparent">
      <div className="absolute pl-10 sm:pl-6 lg:pl-6 left-0 inset-y-0 flex items-center pointer-events-none">
        <SearchIcon
          className="w-3 sm:w-[18px] text-primaryBlue dark:text-gray-300 transition-all duration-200"
          aria-hidden="true"
        />
      </div>
      <input
        ...
        className="block w-full pl-20 sm:pl-12 pr-4 lg:pl-[84px] py-6 sm:py-3 sm:ring-[1px] focus:ring-[3px] ring-[#8EB8FF] dark:ring-baseBlueMid placeholder:text-primaryBlue dark:placeholder:text-bodyGray text-sm sm:text-base leading-[17px] sm:leading-5 font-semibold bg-transparent border-none outline-none sm:rounded-xl transition duration-200"
