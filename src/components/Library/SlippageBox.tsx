...
interface Props {
  setPrevStep: React.Dispatch<React.SetStateAction<boolean>>;
  setCurrentStep: React.Dispatch<React.SetStateAction<boolean>>;
}

const SlippageBox: React.FC<Props> = ({ setPrevStep, setCurrentStep }) => {
