...
export const LEADERBOARD_API_PROD = process.env.NEXT_PUBLIC_LEADERBOARD_API_PROD as string;
export const LEADERBOARD_API_DEV = process.env.NEXT_PUBLIC_LEADERBOARD_API_DEV as string;
...
export const DESCRIPTION = "Discover and earn yield from polkadot and kusama paraverse";
